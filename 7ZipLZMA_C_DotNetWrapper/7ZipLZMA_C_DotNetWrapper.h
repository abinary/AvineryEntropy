...
#include "../7ZipC/C/LzmaLib.h"
#include "../7ZipC/C/LzmaEnc.h"
#include "../7ZipC/C/Alloc.h"

typedef unsigned char byte;
typedef byte byte_array[];
typedef byte* byte_ptr;

namespace My7ZipLZMA_C_DotNetWrapper {
	...
	public:
		...
		long Encode(byte_ptr input, int inputLength, byte_ptr output, int maxOutputLength)
		{
			...
			progress.Progress = (SRes(*)(void *p, UInt64 inSize, UInt64 outSize))(void *) progressDelegatePtr;
		...
		static void SetUncompressedSizeBetweenReports(unsigned int max)
		{
			SetMaxUnpackedBlockSize(max);
		}
